...
\begin{frame}
    \begin{theorem}[Chartrand, Gavlas, Harary, Schultz (1994)]
        A standard integral sequence $\sigma : d_1,d_2,\dots,d_n$ is \textbf{s-graphical} if and only if the sequence
        \begin{equation*}
            \sigma' : d_2-1,\dots,d_{d_1+s+1}-1,d_{d_1+s+2},\dots,d_{n-s},d_{n-s+1}+1,\dots,d_n+1
        \end{equation*}
        is \textbf{s-graphical} for some $0 \leq s \leq \frac{n-1-d_1}{2}$.
    \end{theorem}
