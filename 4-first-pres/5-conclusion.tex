...
\begin{frame}{A little treat.}
	\begin{problem}
		...
		What if we extended this notion again, adding a new \textit{type} of degree, to go from degree types in $\{\pm 1\}$ to $\Z/p\Z$. This shouldn't feel any less natural than what we have shown in this presentation so far.
